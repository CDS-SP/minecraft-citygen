...
from config.config_path import RESOURCE_ROOT, ROOT, WORLDEDIT_SCHEM
...
def main() -> int:
    ...
    if not os.path.isdir(WORLDEDIT_SCHEM):
        print("Action: the final .schem will fall back to the repo-local artifacts/worldedit folder.")
