...
when 02_builds_production/schematics/extract_builds.py writes buildings.json.
...
from config_path import BUILD_CATALOG, BUILDS_SIM
from config_render import BUILD_PREVIEW_COLORS, CONTACT_SHEET_BG
