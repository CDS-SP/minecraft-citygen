...
ROADS_SIM = os.path.join(ROOT, "01_roads_simulation")
ROADS_PROD = os.path.join(ROOT, "01_roads_production")
ROADS_PROD_SCHEM = os.path.join(ROADS_PROD, "schematics")

GRID_SIM = os.path.join(ROOT, "03_grid_simulation")
GRID_PROD = os.path.join(ROOT, "03_grid_production")
GRID_PROD_SCHEM = os.path.join(GRID_PROD, "schematics")

BUILDS_SIM = os.path.join(ROOT, "02_builds_simulation")
BUILDS_PROD = os.path.join(ROOT, "02_builds_production")
BUILDS_PROD_SCHEM = os.path.join(BUILDS_PROD, "schematics")
BUILD_CATALOG = os.path.join(BUILDS_PROD_SCHEM, "buildings.json")

CITY_SIM = os.path.join(ROOT, "04_city_simulation")
CITY_PROD = os.path.join(ROOT, "04_city_production")
