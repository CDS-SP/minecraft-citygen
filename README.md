...
- Download **Installer (.exe)** from [here]([docs/ui3.png](https://github.com/CDS-SP/minecraft-citygen/releases))
- Download **Portable (.zip)** from [here]([docs/ui3.png](https://github.com/CDS-SP/minecraft-citygen/releases))
